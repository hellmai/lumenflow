...
The 6 non-negotiable constraints.`,
  ...
  describe('template variable substitution', () => {
    it('should replace YYYY-MM-DD date patterns with {{DATE}}', async () => {
      ...
      const output = convertToTemplate(input, '/home/USER/source/hellmai/os');
    ...
    it('should replace absolute project paths with {{PROJECT_ROOT}}', async () => {
      ...
      const input = 'cd /home/USER/source/hellmai/os\npnpm wu:done';
      const output = convertToTemplate(input, '/home/USER/source/hellmai/os');
...
Run: cd /home/USER/source/hellmai/os && pnpm gates`;
      const output = convertToTemplate(input, '/home/USER/source/hellmai/os');

...
For detailed troubleshooting, common mistakes, and recovery steps, see [troubleshooting-wu-done.md](docs/_frameworks/lumenflow/agent/onboarding/troubleshooting-wu-done.md).
...
Create an initiative when you genuinely need multiple independently completable WUs, multiple lane owners, or staged rollout across phases. File count alone is not the split signal. Do not split one coherent outcome into separate backend, tests, docs, or cleanup WUs just to satisfy heuristics.
...
11. **Cohesion Before Decomposition**: One coherent outcome stays one WU. Split only when parts can ship, review, and roll back independently.
...
- **docs/\_frameworks/lumenflow/agent/onboarding/** - Agent onboarding documentation
...
For the full worktree lifecycle (parallel execution, bootstrap, isolation guarantees), see [LumenFlow Agent Capsule](docs/_frameworks/lumenflow/lumenflow-agent-capsule.md). For the mandatory pre-write check, see [.lumenflow/constraints.md](.lumenflow/constraints.md).
...
- Allowed dirty prefixes on main: `docs/tasks/wu/`, `.lumenflow/`, `.claude/`, `plan/`
...
> **Complete CLI reference (100+ commands):** See [quick-ref-commands.md](docs/_frameworks/lumenflow/agent/onboarding/quick-ref-commands.md). Always run `<command> --help` for the authoritative option list.
...
For recovery commands, state management, memory coordination, and orchestration tools, see [quick-ref-commands.md](docs/_frameworks/lumenflow/agent/onboarding/quick-ref-commands.md).
...
1. [docs/\_frameworks/lumenflow/agent/onboarding/troubleshooting-wu-done.md](docs/_frameworks/lumenflow/agent/onboarding/troubleshooting-wu-done.md) - Most common mistake
2. [docs/\_frameworks/lumenflow/agent/onboarding/first-wu-mistakes.md](docs/_frameworks/lumenflow/agent/onboarding/first-wu-mistakes.md) - First WU pitfalls
3. [docs/\_frameworks/lumenflow/agent/onboarding/agent-safety-card.md](docs/_frameworks/lumenflow/agent/onboarding/agent-safety-card.md) - Safety guardrails
4. [docs/\_frameworks/lumenflow/agent/onboarding/quick-ref-commands.md](docs/_frameworks/lumenflow/agent/onboarding/quick-ref-commands.md) - Command reference
5. [docs/\_frameworks/lumenflow/agent/onboarding/test-ratchet.md](docs/_frameworks/lumenflow/agent/onboarding/test-ratchet.md) - Test baseline ratchet pattern
...
- [LumenFlow Agent Capsule](docs/_frameworks/lumenflow/lumenflow-agent-capsule.md) -- Full framework reference (lifecycle, lanes, gates, DoD)

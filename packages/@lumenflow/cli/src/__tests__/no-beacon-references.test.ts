 ...
 * Guardrail test: `._legacy` is legacy and must not be referenced in live operational
...
describe('no legacy ._legacy references in live operational files (WU-1529)', () => {
  it('should not contain ._legacy references in active hooks, overlays, templates, and rules', () => {

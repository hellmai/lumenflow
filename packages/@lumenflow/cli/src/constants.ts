...
/**
 * Milliseconds per hour and per day.
 * WU-2048: Re-exported from canonical source @lumenflow/core/constants/duration-constants.
 */
export { MS_PER_HOUR, MS_PER_DAY } from '@lumenflow/core/constants/duration-constants';

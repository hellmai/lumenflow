...
export const PUBLIC_MANIFEST: PublicCommand[] = [
  ...
  },
  {
    ...
    description: 'Refresh core docs, onboarding docs, and supported vendor assets',
    category: COMMAND_CATEGORIES.SETUP_DEVELOPMENT,
  },
  {
    name: 'docs:sync',
    binName: 'lumenflow-docs-sync',
    binPath: './dist/docs-sync.js',
    description: 'Refresh core docs, onboarding docs, and supported vendor assets (alias)',
    category: COMMAND_CATEGORIES.SETUP_DEVELOPMENT,
    surface: 'alias',
  },
  {

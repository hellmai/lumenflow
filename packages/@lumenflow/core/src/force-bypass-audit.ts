 ...
 * All hooks log bypass events to ._legacy/force-bypasses.log for accountability.
 *
 * Key principles:
 ...
 * - GIT-TRACKED: ._legacy/force-bypasses.log is version controlled
 *
 * Log format:
 ...
 */
const LOG_FILE_NAME = '._legacy/force-bypasses.log';

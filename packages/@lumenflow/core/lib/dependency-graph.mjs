...
import { detectCycles } from './initiative-validator.mjs';
import { STRING_LITERALS, WU_STATUS } from './wu-constants.mjs';
 ...
 *
 * @example
 * import { buildDependencyGraph, renderASCII, renderMermaid, topologicalSort, criticalPath, bottlenecks } from './lib/dependency-graph.mjs';
 *

...
import { readWURaw } from './wu-yaml.mjs';
import { PATTERNS, TEST_TYPES, LOG_PREFIX, EMOJI } from './wu-constants.mjs';
// WU-1810: Import canonical schema for full validation
import { BaseWUSchema } from './wu-schema.mjs';
// WU-1810: Import fixer to detect fixable issues
import { detectFixableIssues, FIXABLE_ISSUES } from './wu-yaml-fixer.mjs';

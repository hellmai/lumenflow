...
export const TOOL_PATHS = {
  VALIDATE_BACKLOG_SYNC: 'node tools/validate-backlog-sync.mjs',
  SUPABASE_DOCS_LINTER: 'node packages/linters/supabase-docs-linter.mjs',
  /** WU-2315: System map validator script */
  SYSTEM_MAP_VALIDATE: 'node tools/system-map-validate.mjs',
};
...
export const SCRIPT_PATHS = {
  ...
  VALIDATE_PROMPT_REGISTRY: 'tools/validate-prompt-registry.mjs',
};
 ...
 *
 * @example
 * import { getProjectRoot } from './lib/wu-constants.mjs';

...
import { validateSpawnEvent, generateSpawnId, SpawnStatus } from './spawn-registry-schema.mjs';
...
export class SpawnRegistryStore {
  ...
  constructor(baseDir) {
    ...
    /** @type {Map<string, import('./spawn-registry-schema.mjs').SpawnEvent>} */
    this.spawns = new Map();
   ...
   *
   * @private
   * @param {import('./spawn-registry-schema.mjs').SpawnEvent} event - Event to apply
   */
  _applyEvent(event) {
   ...
   *
   * @private
   * @param {import('./spawn-registry-schema.mjs').SpawnEvent} event - Event to append
   * @returns {Promise<void>}
   ...
   * @returns {import('./spawn-registry-schema.mjs').SpawnEvent[]} Array of spawn events
   *
   * @example
   ...
   * @returns {import('./spawn-registry-schema.mjs').SpawnEvent | null} Spawn event or null
   *
   * @example
   ...
   *
   * @returns {import('./spawn-registry-schema.mjs').SpawnEvent[]} Array of pending spawn events
   *
   * @example
   * const pending = store.getPending();
   */

...
export class WUStateStore {
   ...
   *
   * @private
   * @param {import('./wu-state-schema.mjs').WUEvent} event - Event to apply
   */
  _applyEvent(event) {
   ...
   *
   * @private
   * @param {import('./wu-state-schema.mjs').WUEvent} event - Event to append
   * @returns {Promise<void>}
   ...
   * @returns {import('./wu-state-schema.mjs').WUEvent}

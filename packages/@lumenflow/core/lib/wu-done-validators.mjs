...
import { die, createError, ErrorCodes } from './error-handler.mjs';
import { WU_PATHS } from './wu-paths.mjs';
import { EXIT_CODES } from './wu-constants.mjs';
// WU-1352: Use centralized YAML functions from wu-yaml.mjs
import { readWU, writeWU, parseYAML } from './wu-yaml.mjs';
...
import { createStamp } from './stamp-utils.mjs';
...
import {
  ...
  computeStampContent,
} from './wu-transaction-collectors.mjs';
...
import { PLACEHOLDER_SENTINEL } from './wu-schema.mjs';
// WU-1433: Manual test escape hatch validator
import { validateAutomatedTestRequirement } from './manual-test-validator.mjs';
// WU-1440: Import merged check for branch deletion
import { isBranchAlreadyMerged } from './wu-done-worktree.mjs';
// WU-2241: Import cleanup lock for concurrent collision prevention
import { withCleanupLock } from './cleanup-lock.mjs';
// WU-1805: Import preflight validators for code_paths validation
import { validatePreflight } from './wu-preflight-validators.mjs';
// WU-2242: Import isDocumentationPath for test_paths enforcement
import { isDocumentationPath } from './file-classifiers.mjs';
// WU-2278: Import ownership validation for cross-agent protection
import { validateWorktreeOwnership } from './worktree-ownership.mjs';
// WU-2278: Import cleanup install config for timeout and CI mode
import { getCleanupInstallConfig, CLEANUP_INSTALL_TIMEOUT_MS } from './cleanup-install-config.mjs';
...
export function runPreflightTasksValidation(id, options = {}) {
  ...
  try {
    ...
    execSyncFn('node tools/validate.mjs', {
      stdio: STDIO.PIPE,
...
export function validateAllPreCommitHooks(id, worktreePath = null, options = {}) {
  ...
  try {
    ...
    execSyncFn('node tools/gates-pre-commit.mjs', execOptions);

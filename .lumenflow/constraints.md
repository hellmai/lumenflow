...
- `Write(docs/operations/tasks/wu/WU-XXX.yaml, ...)` -- use `pnpm wu:edit` instead
- `Edit(docs/operations/tasks/wu/WU-XXX.yaml, ...)` -- use `pnpm wu:edit` instead
...
Context compaction causes agents to lose critical rules. See [wu-sizing-guide.md](../docs/operations/_frameworks/lumenflow/wu-sizing-guide.md) for mandatory thresholds and the spawn-fresh protocol.

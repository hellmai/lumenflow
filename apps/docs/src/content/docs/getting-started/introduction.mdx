...
<Aside type="tip">
  LumenFlow ships with first-party packs for software delivery, workspace productivity, and governed
  model turns. The pack system also lets you extend LumenFlow to any domain — infrastructure,
...
- [Software Delivery Pack](/packs/software-delivery) — The built-in pack for software teams

...
| `agent-runtime`          | `packages/@lumenflow/packs/agent-runtime`     | Governed turn execution, provider adapters, policy/capability factories, and `agent-session` orchestration | kernel (types only)                               |

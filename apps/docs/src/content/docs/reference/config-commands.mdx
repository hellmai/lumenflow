...
description: CLI commands for safe .lumenflow.config.yaml modification
---

import { Aside, Tabs, TabItem } from '@astrojs/starlight/components';

CLI commands for safely reading and modifying `.lumenflow.config.yaml` with Zod schema validation.

...
| Category            | Commands                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Gates & Quality     | [`gate:co-change`](#gateco-change), [`gates`](#gates), [`lane:create`](#lanecreate), [`lane:edit`](#laneedit), [`lane:health`](#lanehealth), [`lane:lock`](#lanelock), [`lane:setup`](#lanesetup), [`lane:status`](#lanestatus), [`lane:suggest`](#lanesuggest), [`lane:validate`](#lanevalidate), [`lumenflow:pre-commit-check`](#lumenflowpre-commit-check), [`validate`](#validate)                                                                                                                                                                                                                                                                                                                |
...
<Aside type="note" title="Ownership guards (v3.19.0)">
  `wu:block`, `wu:unblock`, `wu:release`, and `wu:recover` validate session ownership before
  allowing state mutations. If the active session differs from the WU's claimed session, you'll
  see a `SESSION OWNERSHIP VIOLATION` or `CLAIM OWNERSHIP VIOLATION` error. Use
  `--override-owner --reason "..."` for manual cross-session recovery. All overrides are audited
  to `.lumenflow/ownership-override-audit.log`.
</Aside>

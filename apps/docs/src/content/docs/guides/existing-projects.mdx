...
3. **Review generated files**
   ...
   <FileTree>
     - .lumenflow.config.yaml (your configuration) - LUMENFLOW.md (workflow entry point) -
     .lumenflow/ - constraints.md (non-negotiable rules) - agents/ (AI agent guidance) -
     docs/04-operations/tasks/ (with --full) - backlog.md - status.md - wu/ (WU spec directory)
   </FileTree>

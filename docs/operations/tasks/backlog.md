...
> Agent: Read **docs/operations/\_frameworks/lumenflow/agent/onboarding/starting-prompt.md** first, then follow **docs/operations/\_frameworks/lumenflow/lumenflow-complete.md** for execution.

# Backlog (single source of truth)

## 🚀 Ready (pull from here)

- [WU-2476 — Sync internal and Starlight docs to v3.19.0](wu/WU-2476.yaml) — Content: Documentation
...
- [WU-2476 — Remove stale onboarding sizing guide copy on upgrade](wu/WU-2476.yaml) — Framework: CLI

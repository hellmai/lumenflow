...
Initiatives are defined in `docs/operations/tasks/initiatives/INIT-001.yaml`:
...
See [agent-invocation-guide.md](../../../docs/operations/_frameworks/lumenflow/agent/onboarding/agent-invocation-guide.md) for decision tree.

...
**Source**: `docs/operations/_frameworks/lumenflow/lumenflow-agent-capsule.md` (canonical)
...
**Full spec**: [LumenFlow Agent Capsule](../../../docs/operations/_frameworks/lumenflow/lumenflow-agent-capsule.md)

...
**Full docs**: [agent-invocation-guide.md](../../../docs/operations/_frameworks/lumenflow/agent/onboarding/agent-invocation-guide.md) | [execution-memory skill](../execution-memory/SKILL.md)

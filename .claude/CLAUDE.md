...
For complete onboarding: [starting-prompt.md](../docs/operations/_frameworks/lumenflow/agent/onboarding/starting-prompt.md).
...
For details, see the [YAML editing policy](../.lumenflow/rules/yaml-editing-policy.md) and [agent safety architecture](../docs/operations/_frameworks/lumenflow/agent-safety-architecture.md).

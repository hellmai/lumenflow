...
- `._legacy/stamps/WU-*.done` — Completion stamps
...
**Path:** `._legacy/stamps/WU-XXX.done`
...
1. **Update WU YAML:**
   ...
   artifacts: ['._legacy/stamps/WU-XXX.done', ...]
...
- [ ] `._legacy/stamps/WU-XXX.done` file exists
